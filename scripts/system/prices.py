...
def build_market():
    return [
        MarketItem("game.buy.ammo", 50, 200, assets.MARKET_AMMO),
        MarketItem("game.buy.repairs", 2000, 2, assets.MARKET_REPAIRS),
        MarketItem("game.buy.damage", 3000, 1, assets.MARKET_DAMAGE_BOOST)
    ]