...
from scripts.system.constants import ONE_SECOND, COLOR_WHITE, COLOR_RED, PHASE_ACTIVE
from scripts.engine.utils import center
...
def game_lost(game, font, screen, screen_size):
    ...
    game_over = font.render(game.local.t('game.defeat'), True, COLOR_RED)
