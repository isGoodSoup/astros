        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_F1:
                    game.state.sandbox_enabled = not game.state.sandbox_enabled
                if game.state.sandbox_enabled:
                    if event.key == pygame.K_1:
                        game.state.sandbox_enemy_type = "Alien"
                    elif event.key == pygame.K_2:
                        game.state.sandbox_enemy_type = "Heavy"
                    elif event.key == pygame.K_3:
                        game.state.sandbox_enemy_type = "Kamikaze"
